...
public class MealAdder extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveInUseRecipies = new File(getApplicationContext().getFilesDir(),"CurrentlyUsedRecipies.txt");
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.meal_done:
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            Log.i(String.valueOf(recipies),"before send");
                            i3.putExtra("usedMeals",recipies);
                            Log.i(String.valueOf(i3.getExtras()),"afeter send");
                            startActivity(i3);
                            dialog.dismiss();
                        }
                    });
                ...
                case R.id.recipe_book:
                    ...
                    Log.i(String.valueOf(allRecipiesString),"recipies sent from mealadder");
